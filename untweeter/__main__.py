...
def main():
 ...
 #                       help='reset the ini file to defaults')
    ...
    parser.add_argument('--tweet-limit', type=int,
                        help='set the limit for tweets')
    parser.add_argument('--fave-limit', type=int,
                        help='set the limit for faves')

    parser.add_argument('--ask-for-keys', action="store_true",
                        help='ask interactively for keys')
